...
public class GenerarNotaDebitoDIAN {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Element debitNote = doc.createElement("DebitNote");
        // ===== Declarar todos los namespaces requeridos por DIAN =====
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns", NS_DEBIT_NOTE);
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:cac", NS_CAC);
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:cbc", NS_CBC);
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:ext", NS_EXT);
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:sts", NS_STS);
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:ds", NS_DS);
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xsi", NS_XSI);
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xades", "http://uri.etsi.org/01903/v1.3.2#");
        debitNote.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:xades141", "http://uri.etsi.org/01903/v1.4.1#");

        // schemaLocation
        debitNote.setAttributeNS(NS_XSI, "xsi:schemaLocation",
                NS_DEBIT_NOTE + " http://docs.oasis-open.org/ubl/os-UBL-2.1/xsd/maindoc/UBL-Invoice-2.1.xsd");
        ...
        debitNote.appendChild(textEl(doc, NS_CBC, "cbc:IssueTime", horFac));
        debitNote.appendChild(textEl(doc, NS_CBC, "cbc:DebitNoteTypeCode", "91"));
        ...
        // Parties
        debitNote.appendChild(buildSupplier(doc, nitOfeSinDv, dvOfe));
        debitNote.appendChild(buildCustomer(doc, numAdqSinDv, dvAdq, adqName));

        // PaymentMeans
        Element payMeans = el(doc, NS_CAC, "cac:PaymentMeans");
        debitNote.appendChild(payMeans);
        ...
        debitNote.appendChild(legalTotal);
        ...
        // Línea
        Element line = el(doc, NS_CAC, "cac:DebitNoteLine");
        debitNote.appendChild(line);
        line.appendChild(textEl(doc, NS_CBC, "cbc:ID", "1"));

        Element qty = textEl(doc, NS_CBC, "cbc:DebitedQuantity", "1.000000");
